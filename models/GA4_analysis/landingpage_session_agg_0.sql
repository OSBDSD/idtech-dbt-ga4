# ---aggragte table by landing_page_path, date, traffic_group, traffic_source, by date  (ouput table userd in looker report)

select 
session_partition_date, landing_page_path, Traffic_source_group,  Traffic_source, 
